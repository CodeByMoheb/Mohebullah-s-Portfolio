    ...
    <section id="about" className="py-24">
      ...
      <div className="max-w-4xl">
        ...
        <div className="mt-8">
            ...
            <div className="bg-secondary/70 backdrop-blur-sm p-4 rounded-sm border border-dark-slate/50">
